...
const styles = StyleSheet.create({
  ...
  badgeSection: {
    marginBottom: elementSpacing.relaxed,
  },
  badgeSectionTitle: {
  ...
  badge: {
    width: gameItem.badge,
    height: gameItem.badge,
    alignItems: 'center',
    justifyContent: 'center',
    position: 'relative',
  },
  ...
  badgeIconContainer: {
    width: gameItem.badge - 8,
    height: gameItem.badge - 8,
    borderRadius: (gameItem.badge - 8) / 2,
    alignItems: 'center',
    justifyContent: 'center',
    shadowColor: '#000',
